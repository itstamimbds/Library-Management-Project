class Library:
    ...
    def view_all_books(cls):
        if not cls.book_list:
            print("Right now No books available.")
        else:
...
class Book:
    ...
    def menu():
        while True:
          ...
          choice=input("Enter Your Choice book : ")
...
book1= Book("101","Python programming","Shariful")
book2= Book("102","Data Structures And Algorithm", "Tamim")
book3= Book("103","Computer Pheriferals", "Nahida")
Book.menu()